...
var skins: Dictionary = {}  # skin_id -> TetrisSkin
...
## 获取当前皮肤
func get_current_skin() -> TetrisSkin:
...
## 应用皮肤到绘制器（不保存）
func apply_skin_to_drawer(drawer: TetrisBoardDrawer) -> void:
